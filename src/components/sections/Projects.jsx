...
const Projects = () => {
  ...
  const projects = [
    {
      id: 'sena360',
      title: t('projects.projects.sena360.title'),
      description: t('projects.projects.sena360.description'),
    ...
    {
      id: 'agrovida',
      title: t('projects.projects.agrovida.title'),
      description: t('projects.projects.agrovida.description'),
    ...
    {
      id: 'lotustore',
      title: t('projects.projects.lotustore.title'),
      description: t('projects.projects.lotustore.description'),
